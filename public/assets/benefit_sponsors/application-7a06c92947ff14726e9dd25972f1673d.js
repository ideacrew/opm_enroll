...
;
$(function() {
// Adds datepicker to New Employee form
initDatepicker('eeDOB',new Date('04/01/1919'),new Date('04/01/2003'))
  
initDatepicker('hiredDate',new Date('03/18/2019'),new Date('04/08/2019'))
...
function initPlanOptions(plan_options, location_id) {  
   ...
   $.each(plan_options, function (index, product) {
      ...
      var productHtml = '<div class="col-xs-4">\
        <div class="col-xs-12 reference-plan">\
          <div class="col-xs-2">\
            <input type="radio" value="' + product["id"] + '" name="' + location_id + '[reference_plan_id]">\
            <label for="' + location_id + '_reference_plan_id">\
              <i class="fa fa-circle-o"></i>\
              <i class="fa fa-dot-circle-o"></i>\
            </label>\
          ...
          <div class="col-xs-10">\
            <div class="panel row">\
              ...
              <div class="panel-body">\
                <span class="plan-label">Type: </span><span>' + product["product_type"] + '</span><br>\
                <span class="plan-label">Carrier: </span><span>' + product["carrier_name"] + '</span><br>\
                <span class="plan-label">Level: </span><span>' + product["metal_level_kind"] + '</span><br>\
              </div>\
            </div>\
...
// Initalize Datepickers for elements
$(function() {
  // Pass element ID, minDate, maxDate for datepicker options
  initDatepicker('inputDOB',new Date('04/01/1929'),new Date('04/30/2001'));
});
